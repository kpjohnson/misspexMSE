...
## HighR0 FixR0 FixSel ####
Dirn <- "E:/ratpacktest/highR0/fixR0_fixSel/Stock_Synthesis"
Scen <- Scenario[1]
R0_status <- R0Status[2]
Sel_status <- SelStatus[2]
...
vline_data <- data.frame(
  ...
  ParStatus = rep(c("LowR0 R0Est SelEst", "LowR0 R0Pre SelPre",  "HighR0 R0Est SelEst", "HighR0 R0Pre SelPre"), 
                  each=4),
...
png(filename="Plots//Minimal EM R0 Sel Parameter Distributions.png", width=7, height=5, units="in", res=200)
